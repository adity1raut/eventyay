...
def get_submission_speakers(submission: Submission, *, for_reviewers: bool) -> list[SubmissionSpeaker]:
    ...
    for speaker in speakers:
        ...
        result.append(
            SubmissionSpeaker(
                ...
                other_submissions=tuple(other for other in speaker._event_submissions if other.code != submission.code),
            )
        )
    return result
